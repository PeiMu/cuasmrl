...
torch.manual_seed(0)
a = torch.randn((512, 512), device='cuda', dtype=torch.float16) - 0.5
b = torch.randn((512, 512), device='cuda', dtype=torch.float16) - 0.5
...
configs.append(
    triton.testing.Benchmark(
        ...
        x_vals=[[512, 512, 2048]],  # Different possible values for `x_name`
