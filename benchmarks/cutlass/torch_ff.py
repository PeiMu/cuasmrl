...
def main():
    ...
    if drl_config.load is None:
        ...
        load_dir = f'{drl_config.default_out_path}/{GPU}/ff/{B}_{M}_{N}_{K}'
    else:
    ...
    @fgk_autotune(
        configs=[
            ...
            triton.Config({'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 256, 'BLOCK_SIZE_K': 32, 'GROUP_SIZE_M':8, 'USE_FP8': False, 'EPS': 1e-6 }, num_stages=4, num_warps=4),
            triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 128, 'BLOCK_SIZE_K': 32, 'GROUP_SIZE_M':8, 'USE_FP8': False, 'EPS': 1e-6 }, num_stages=4, num_warps=4),
            triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 32, 'GROUP_SIZE_M':8, 'USE_FP8': False, 'EPS': 1e-6 }, num_stages=4, num_warps=4),
            triton.Config({'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 128, 'BLOCK_SIZE_K': 32, 'GROUP_SIZE_M':8, 'USE_FP8': False, 'EPS': 1e-6 }, num_stages=4, num_warps=4),
            triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 32, 'BLOCK_SIZE_K': 32, 'GROUP_SIZE_M':8, 'USE_FP8': False, 'EPS': 1e-6 }, num_stages=4, num_warps=4),
            triton.Config({'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 32, 'BLOCK_SIZE_K': 32, 'GROUP_SIZE_M':8, 'USE_FP8': False, 'EPS': 1e-6 }, num_stages=5, num_warps=2),
            triton.Config({'BLOCK_SIZE_M': 32, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 32, 'GROUP_SIZE_M':8, 'USE_FP8': False, 'EPS': 1e-6 }, num_stages=5, num_warps=2),
